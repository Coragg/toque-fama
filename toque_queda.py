...
while True:
    ...
    if confirmar_jugar.upper() == "S":
        ...
        if cantidad_digitos == 4:
            ...
            sexto_numero_aleatorio = random.randrange(10)
            septimo_numero_aleatorio = random.randrange(10)
            while primer_numero_aleatorio == segundo_numero_aleatorio or primer_numero_aleatorio == tercer_numero_aleatorio or primer_numero_aleatorio == cuarto_numero_aleatorio or primer_numero_aleatorio == quinto_numero_aleatorio or primer_numero_aleatorio == segundo_numero_aleatorio or primer_numero_aleatorio == septimo_numero_aleatorio or segundo_numero_aleatorio == tercer_numero_aleatorio or segundo_numero_aleatorio == cuarto_numero_aleatorio or segundo_numero_aleatorio == quinto_numero_aleatorio or segundo_numero_aleatorio == sexto_numero_aleatorio or segundo_numero_aleatorio == septimo_numero_aleatorio or tercer_numero_aleatorio == cuarto_numero_aleatorio or tercer_numero_aleatorio == quinto_numero_aleatorio or cuarto_numero_aleatorio == quinto_numero_aleatorio:
                primer_numero_aleatorio = random.randrange(10)
                segundo_numero_aleatorio = random.randrange(10)
                tercer_numero_aleatorio = random.randrange(10)
                cuarto_numero_aleatorio = random.randrange(10)
